          ...
          {indicators.map((i) => {
            ...
            return (
              <TableRow key={i.id}>
                ...
                <TableCell className="font-mono">{e ? formatValue(e.actual_value, i.value_type) : "—"}</TableCell>
                <TableCell className="font-mono">{t ? formatValue(t.target_value, i.value_type) : "—"}</TableCell>
