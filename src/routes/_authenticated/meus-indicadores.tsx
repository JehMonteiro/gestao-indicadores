    ...
    <div>
      ...
      <Card><Table>
        <TableHeader><TableRow>
          <TableHead>Indicador</TableHead><TableHead>Setor</TableHead><TableHead>Último valor</TableHead><TableHead>Meta</TableHead><TableHead>%</TableHead><TableHead>Classificação</TableHead>
