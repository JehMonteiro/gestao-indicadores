...
type Actions = {
  ...
  upsertIndicator: (i: Indicator) => Promise<void>;
...
export function canSeeRoute(role: GlobalRole | undefined, route: string): boolean {
  ...
  const roleMatrix: Record<string, GlobalRole[]> = {
    ...
    "/desempenho-franquias": ["superadmin", "admin_corporativo", "gestor_setor", "colaborador", "gestor_franquia", "franqueado", "auditor"],
    "/lancamentos": ["superadmin", "admin_corporativo", "gestor_setor", "colaborador", "gestor_franquia", "franqueado", "auditor"],
    "/lancamentos-franquia": ["superadmin", "admin_corporativo", "gestor_setor", "colaborador", "gestor_franquia", "franqueado", "auditor"],
    ...
    "/chamados": ["superadmin", "admin_corporativo", "gestor_setor"],
